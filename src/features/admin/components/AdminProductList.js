         ...
         <MobileFilter filters={filters} handleFilter={handleFilter} mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen}   />
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {/* Section of product and filter end here  */}
             ...
             <Pagination filters={filters} page={page} totalItems={totalItems} setpage={setpage} handlePage={handlePage} />
...
function Pagination({handlePage,filters,page,setpage,totalItems=10}){
