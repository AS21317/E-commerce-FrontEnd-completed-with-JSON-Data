...
const Checkout = () => {
 ...
 <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
    <div className='lg:col-span-3'>
        ...
        <form className='bg-white text-left px-6  '>
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex border-solid border-2 mt-5 border-gray-300 px-5 justify-between gap-x-6 py-5">
    ...
    <div className="mx-auto  mt-16 bg-white max-w-7xl px-0 sm:px-0 lg:px-0">
                  <h2 className=' text-4xl font-bold tracking-tight pt-6 text-left pb-5 px-5 text-gray-900'>Cart</h2>
    ...
    <div className="flow-root">
      <ul role="list" className="-my-6 divide-y divide-gray-200">
        {products.map((product) => (
          <li key={product.id} className="flex  mb-10 py-6">
